...
class TreatmentApp:
    ...
    def confirm_treatments(self):
        confirmed_treatments_text = "Confirmed treatments:\n" + "\n".join(
            f"{disease}: {treatment['description']}" for disease, treatment in self.recommended_treatments.items()
        )
        ctk.CTkLabel(self.page_two, text=confirmed_treatments_text).pack(pady=10)
